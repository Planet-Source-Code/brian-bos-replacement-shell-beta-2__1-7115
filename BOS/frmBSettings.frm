...
Begin VB.Form frmBSettings 
   ...
   Begin VB.CheckBox rndSkin 
      Caption         =   "Random skin on startup"
      Height          =   255
      Left            =   1140
      TabIndex        =   13
      Top             =   2280
   ...
   Begin VB.CheckBox Check2 
      Caption         =   "Show desktop icons [not implemented]"
      Enabled         =   0   'False
      Height          =   315
      Left            =   660
      TabIndex        =   2
...
Dim TaskbarRefresh As Boolean, IconRefresh As Boolean, ShowAddress As Boolean
