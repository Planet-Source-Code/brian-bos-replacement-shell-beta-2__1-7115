...
Begin VB.Form frmBstart 
   ...
   Begin MSComctlLib.ImageList imagesdown 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":33B0A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":38B5E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":3DBB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imageshover 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":51CF0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":56D44
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList images 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":5BD98
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":60DEC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":65E40
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBstart.frx":6AE94
            Key             =   ""
         EndProperty
      EndProperty
   End
...
b = 0
If SubShown(0) Then b = frmShutdownSubMenu.hwnd Else b = -1
If SubShown(1) Then b = frmHelpSubMenu.hwnd Else c = -1
If SubShown(2) Then b = frmSettingsSubMenu.hwnd Else c = -1

If TaskbarOpen And a <> Me.hwnd And b <> a Then
    HideStartMenu
End If
End Sub
